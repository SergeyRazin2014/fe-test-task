...
Для запуска проекта необходимо установить зависимости для бека и фронта, далее сначала запустить бек потом фронт
для этого: в консоли перейдите в корень проекта и запустите команды:
